...
{
    public class AlmsDonationValidator : BaseValidator<AlmsDonationViewModel>
    {
        public AlmsDonationValidator()
        {
        ...
        .NotEmpty().WithMessage("Şehir Boş Geçilemez");
            ...
            RuleFor(x => x.AlmsAmount)
        .NotEmpty().WithMessage("Zekat Miktarı Boş Geçilemez");
