...
{
    public class GeneralDonationValidator : BaseValidator<GeneralDonationViewModel>
    {
        public GeneralDonationValidator()
        {
...
.NotEmpty().WithMessage("Email Boş Geçilemez");
        ...
        .NotEmpty().WithMessage("Bağış Miktarı Boş Geçilemez");
