...
{
    public class RansomDonationValidator : BaseValidator<RansomDonationViewModel>
    {
        public RansomDonationValidator()
        {
        ...
        .NotEmpty().WithMessage("Şehir Boş Geçilemez");
            ...
            RuleFor(x => x.RansomAmount)
        .NotEmpty().WithMessage("Fidye Miktarı Boş Geçilemez");
