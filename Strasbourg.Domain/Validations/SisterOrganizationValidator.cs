...
{
    public class SisterOrganizationValidator : BaseValidator<SisterOrganizationViewModel>
    {
        public SisterOrganizationValidator()
        {
            RuleFor(x => x.Name)
            ...
            RuleFor(x => x.EstablishmentYear)
             .NotEmpty().WithMessage("Kuruluş Yılı Boş Geçilemez.");
