...
window.onload = function () {
    ...
    const name = document.getElementById('onlinepayment_namesurname');
    const cardnumber = document.getElementById('onlinepayment_cardnumber');
    const expirationdate = document.getElementById('onlinepayment_expirationdate');
    const securitycode = document.getElementById('onlinepayment_securitycode');
